...
public class PersonnelAddMailPageController {
    ...
    @FXML Label userNameLabel, errorLabel, recipientError, senderError, sizeError, buildingError, roomNumberError;
    ...
    @FXML public void handleAccountSettingImageOnAction(MouseEvent event) throws IOException {
        ...
        setting.setPrevPage("PersonnelAddMail");
        stage.show();
    }
