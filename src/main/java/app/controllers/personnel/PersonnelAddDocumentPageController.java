...
public class PersonnelAddDocumentPageController {
    ...
    ObservableList<String> priorityList = FXCollections.observableArrayList("Low", "Normal", "High", "Urgent", "Secret");

    @FXML Button roomListBtn, addGuestBtn, addItemBtn, backBtn, addRoomBtn, browseImageBtn;
    @FXML Label userNameLabel, errorLabel, recipientError, senderError, sizeError, priorityError, buildingError, roomNumberError;
